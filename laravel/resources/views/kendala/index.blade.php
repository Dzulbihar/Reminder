      ...
      <div class="col-12">
        <div class="card">
          ...
          <div class="card-body">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    @if(auth()->user()->name == $kt->user_entry || auth()->user()->role == 'Admin')
                    ...
                    @endif
                    <!-- <a href="{{ url('kendala') }}/{{$kt->id}}/{{('delete')}}" class="btn btn-danger btn-sm" onclick="return confirm('Yakin mau dihapus ?')">
                      <i class="fa fa-trash"></i>
                        Delete
                    </a> -->
                  </td>
            ...
            <div>
              <a href="{{url('kendala')}}/{{('add')}}" class="btn btn-success btn-sm">
                <i class="fa fa-plus"></i>
                Tambah Data
              </a>
              <a href="{{url('kendala')}}/{{('log')}}" class="btn btn-danger btn-sm">
